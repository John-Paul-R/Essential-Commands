...
//            `essentialcommands.<command>.*`
    @SuppressWarnings({"checkstyle:constantname", "checkstyle:staticvariablename", "CheckStyle"})
    public static final class Registry {
        ...
        public static final String warp_set                  = "essentialcommands.warp_set";
        public static final String warp_tp                   = "essentialcommands.warp_tp";
        public static final String warp_delete               = "essentialcommands.warp_delete";
        public static final String warp_tp_named             = "essentialcommands.warp_tp_named";
        ...
        public static final String spawn_tp                  = "essentialcommands.spawn_tp";
        public static final String spawn_set                 = "essentialcommands.spawn_set";
        public static final String nickname_self             = "essentialcommands.nickname_self";
        public static final String nickname_others           = "essentialcommands.nickname_others";
        public static final String nickname_reveal           = "essentialcommands.nickname_reveal";
        public static final String nickname_style_color      = "essentialcommands.nickname_style.color";
        public static final String nickname_style_fancy      = "essentialcommands.nickname_style.fancy";
        public static final String nickname_style_hover      = "essentialcommands.nickname_style.hover";
        public static final String nickname_style_click      = "essentialcommands.nickname_style.click";
        public static final String nickname_selector_and_ctx = "essentialcommands.nickname_style.selector_and_context";
        public static final String nickname_placeholders     = "essentialcommands.nickname_style.nickname_placeholders";
        public static final String randomteleport            = "essentialcommands.randomteleport";
        public static final String fly_self                  = "essentialcommands.fly_self";
        public static final String fly_others                = "essentialcommands.fly_others";
        public static final String invuln_self               = "essentialcommands.invuln_self";
        public static final String invuln_others             = "essentialcommands.invuln_others";
